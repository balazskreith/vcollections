...
public class ChainedStoragesTest implements StorageTest<String, String, ChainedStorages<String, String>> {
	...
	private IStorage<String, String> makeStorage(IStorage<String, String> storage1, IStorage<String, String> storage2, Map<String, String> initialEntries, long maxSize) {
		IStorage<String, String> result = new ChainedStorages<>(initialEntries, maxSize, new KeyGeneratorFactory().make(String.class), storage1, storage2);
		return result;
	}
	...
	/**
	 * <p>Given</p>: two com.wobserver.vcollections.storages, with unlimited capacity
	 *
	...
	public void shouldNotCreateForTwoUnlimitedStorages() {
		...
		Assertions.assertThrows(IllegalStateException.class, () -> {
			IStorage<String, String> chainStorage = new ChainedStorages<>(new KeyGeneratorFactory().make(String.class), storage1, storage2);
		});
	}

	/**
	 * <p>Given</p>: two com.wobserver.vcollections.storages, with (inf, 1) capacities
	 *
	 * <p>When</p>: We try to construct a chain storage
	 *
	 * <p>Then</p> it throws {@link IllegalStateException}
	...
	public void shouldNotCreateWithoutStorage() {
		...
		Assertions.assertThrows(NotAvailableStorage.class, () -> {
			IStorage<String, String> chainStorage = new ChainedStorages<>(new KeyGeneratorFactory().make(String.class));
		});
	}
	...
	public void shouldNotCreateWithZeroStorage() {
		...
		// When
		Assertions.assertThrows(IllegalStateException.class, () -> {
			IStorage<String, String> chainStorage = new ChainedStorages<>(new KeyGeneratorFactory().make(String.class), storage);
		});
	}
	...
	public void shouldUpdateTheSameStorage() {
		...
		IStorage<String, String> storage1 = new MemoryStorage<String, String>(null, null, 2L);
		IStorage<String, String> storage2 = new MemoryStorage<String, String>(null, null, null);
		IStorage<String, String> chainStorage = new ChainedStorages<>(3L, new KeyGeneratorFactory().make(String.class), storage1, storage2);
		chainStorage.update("k1", "v1");
		chainStorage.update("k2", "v2");
		chainStorage.update("k3", "v3");
