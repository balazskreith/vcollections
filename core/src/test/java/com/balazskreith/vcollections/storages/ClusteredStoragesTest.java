...
class ClusteredStoragesTest implements StorageTest<String, String, ClusteredStorages<String, String>> {
	...
	private IStorage<String, String> makeStorage(IStorage<String, String> storage1, IStorage<String, String> storage2, Map<String, String> initialEntries, long maxSize) {
		IStorage<String, String> result = new ClusteredStorages<String, String>(initialEntries, maxSize, new KeyGeneratorFactory().make(String.class), storage1, storage2);
		return result;
	}
	...
	public void shouldNotCreateForTwoUnlimitedStorages() {
		...
		Assertions.assertThrows(IllegalStateException.class, () -> {
			IStorage<String, String> chainStorage = new ClusteredStorages<>(new KeyGeneratorFactory().make(String.class), storage1, storage2);
		});
	}
	...
	public void shouldNotCreateIfTheFirstStorageIsUnlimited() {
		...
		// When
		Assertions.assertThrows(IllegalStateException.class, () -> {
			IStorage<String, String> chainStorage = new ClusteredStorages<>(0L, new KeyGeneratorFactory().make(String.class), storage1, storage2);
		});
	}
	...
	public void shouldNotCreateWithoutStorage() {
		...
		Assertions.assertThrows(NotAvailableStorage.class, () -> {
			IStorage<String, String> chainStorage = new ClusteredStorages<>(new KeyGeneratorFactory().make(String.class));
		});
	}
