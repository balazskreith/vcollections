...
//	private final Class<K> keyType;
	...
	public FileStorage(IMapper<K, String> keyMapper, Class<V> valueType, ObjectMapper valueMapper, String directory, Supplier<K> keyGenerator, Long capacity) throws IOException {
