 ...
 * @param <V>
 */
public class ChainedVStorage<K, V> implements IStorage<K, V>, ISetKeyGenerator<K> {
	 ...
	 */
	public ChainedVStorage(Map<K, V> initialEntries, long maxCapacity, Supplier<K> keyGenerator, IStorage<K, V>... storages) {
	 ...
	 */
	public ChainedVStorage(Supplier<K> keyGenerator, IStorage<K, V>... storages) {
	 ...
	 * @see ChainedVStorage#ChainedVStorage(Map, long, Supplier, IStorage[])
	 */
	public ChainedVStorage(Long maxCapacity, Supplier<K> keyGenerator, IStorage<K, V>... storages) {
