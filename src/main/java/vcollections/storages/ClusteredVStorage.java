...
/**
 * Chains hte vcollections.storages passed to supervise by this type of virtual storage
 * <p>
 ...
 * @param <V>
 */
public class ClusteredVStorage<K, V> implements IStorage<K, V>, IAccessKeyGenerator<K> {
	 ...
	 *                               - if there is not available space in the underlying vcollections.storages
	 ...
	 */
	public ClusteredVStorage(Map<K, V> initialEntries, long maxCapacity, IKeyGenerator<K> keyGenerator, IStorage<K, V>... storages) {
	 ...
	 */
	public ClusteredVStorage(IKeyGenerator<K> keyGenerator, IStorage<K, V>... storages) {
	 ...
	 * {@code maxCapacity} defaults to {@link IStorage#NO_MAX_SIZE}.
	 *
	 * @see ClusteredVStorage#ClusteredVStorage(Map, long, IKeyGenerator, IStorage[])
	 */
	public ClusteredVStorage(Long maxCapacity, IKeyGenerator<K> keyGenerator, IStorage<K, V>... storages) {
	...
	/**
	 * Clear all underlying vcollections.storages and reset the number of entries
	 */
	@Override
	public void clear() {
	...
	/**
	 * Returns with an iterator iterates through the key value pairs of the underlying vcollections.storages
	 *
	 * @return
	 */
	@Override
