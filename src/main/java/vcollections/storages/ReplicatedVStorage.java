...
public class ReplicatedVStorage<K, V> implements IStorage<K, V>, IAccessKeyGenerator<K> {
	 ...
	 */
	public ReplicatedVStorage(Map<K, V> initialEntries, long maxCapacity, IKeyGenerator<K> keyGenerator, IStorage<K, V>... storages) {
	 ...
	 *
	 * @see ReplicatedVStorage#ReplicatedVStorage(Map, long, IKeyGenerator, IStorage[])
	 */
	public ReplicatedVStorage(IKeyGenerator<K> keyGenerator, IStorage<K, V>... storages) {
