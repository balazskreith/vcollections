...
public class FileStorageTest implements StorageTest<MemoryStorage<String, String>> {
	...
	public IStorage<String, String> makeStorage(long maxSize, String... items) {
		...
		try {
			result = new FileStorage<>(SimpleMapperFactory.make(String.class, String.class), String.class, new ObjectMapper(), tempDir.getPath(), SimpleKeyGeneratorFactory.make(String.class), maxSize);
