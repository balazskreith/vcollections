...
public class ChainedVStorageTest implements StorageTest<ChainedVStorage<String, String>> {
	...
	private IStorage<String, String> makeStorage(IStorage<String, String> storage1, IStorage<String, String> storage2, Map<String, String> initialEntries, long maxSize) {
		IStorage<String, String> result = new ChainedVStorage<>(initialEntries, maxSize, SimpleKeyGeneratorFactory.make(String.class), storage1, storage2);
		return result;
	}
	...
	public IStorage<String, String> makeStorage(long maxSize, String... items) {
		...
		IStorage<String, String> result = makeStorage(
				new MemoryStorage<String, String>(2L),
				new MemoryStorage<String, String>(IStorage.NO_MAX_SIZE),
				pairs,
				maxSize
		);
	...
	/**
	 * <p>Given</p>: two storages, with unlimited capacity
	 *
	...
	public void shouldNotCreateForTwoUnlimitedStorages() {
		...
		Assertions.assertThrows(IllegalStateException.class, () -> {
			IStorage<String, String> chainStorage = new ChainedVStorage<>(SimpleKeyGeneratorFactory.make(String.class), storage1, storage2);
		});
	}

	/**
	 * <p>Given</p>: two storages, with (inf, 1) capacities
	 *
	 * <p>When</p>: We try to construct a chain storage
	 *
	 * <p>Then</p> it throws {@link IllegalStateException}
	...
	public void shouldNotCreateWithoutStorage() {
		...
		Assertions.assertThrows(NotAvailableStorage.class, () -> {
			IStorage<String, String> chainStorage = new ChainedVStorage<>(SimpleKeyGeneratorFactory.make(String.class));
		});
	}
	...
	public void shouldNotCreateWithZeroStorage() {
		// Given
		IStorage<String, String> storage = new MemoryStorage<String, String>(SimpleKeyGeneratorFactory.make(String.class), 0L);

		// When
		Assertions.assertThrows(IllegalStateException.class, () -> {
			IStorage<String, String> chainStorage = new ChainedVStorage<>(SimpleKeyGeneratorFactory.make(String.class), storage);
		});
	}
	...
	public void shouldCreateValues() {
		// Given
		IStorage<String, String> storage1 = new MemoryStorage<String, String>(10L);
		IStorage<String, String> storage2 = new MemoryStorage<String, String>();
		IStorage<String, String> chainStorage = new ChainedVStorage<>(SimpleKeyGeneratorFactory.make(String.class), storage1, storage2);
	...
	public void shouldNotUpdateNewKVIfITIsFull() {
		// Given
		IStorage<String, String> storage1 = new MemoryStorage<String, String>(2L);
		IStorage<String, String> storage2 = new MemoryStorage<String, String>();
		IStorage<String, String> chainStorage = new ChainedVStorage<>(SimpleKeyGeneratorFactory.make(String.class), storage1, storage2);
	...
	public void shouldUpdateTheSameStorage() {
		...
		IStorage<String, String> storage1 = new MemoryStorage<String, String>(2L);
		IStorage<String, String> storage2 = new MemoryStorage<String, String>();
		IStorage<String, String> chainStorage = new ChainedVStorage<>(3L, SimpleKeyGeneratorFactory.make(String.class), storage1, storage2);
		chainStorage.update("k1", "v1");
		chainStorage.update("k2", "v2");
		chainStorage.update("k3", "v3");
