...
//		Object result = this.mapper.readValue(yaml, Map.class);
	...
	public void test2() throws IOException {
		StorageProvider storageProvider = new StorageProvider();
		storageProvider.add(new File("/Users/balazskreith.finago/github/vcollections/src/main/resources/vcollection.yaml"));
		IStorage<String, Integer> customers = storageProvider.get("customers");
//		Object result = this.mapper.readValue(yaml, Map.class);
	}
	...
	public void shouldProvideStorages() {
		...
		Map<String, Object> configuration = AbstractBuilderTest.makeMap(
				StorageProvider.KEY_CONFIG_KEY, storageKey1,
				StorageBuilder.BUILDER_CONFIG_KEY, StorageBuilder.MEMORY_STORAGE_CONFIG_KEY,
				...
				StorageBuilder.BUILDER_CONFIG_KEY, StorageBuilder.CACHED_STORAGE_CONFIG_KEY,
